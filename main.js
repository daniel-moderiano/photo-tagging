...
/* harmony export */   "Bytes": () => (/* binding */ Xc),
/* harmony export */   "CACHE_SIZE_UNLIMITED": () => (/* binding */ xc),
/* harmony export */   "CollectionReference": () => (/* binding */ Rc),
/* harmony export */   "DocumentReference": () => (/* binding */ Ic),
/* harmony export */   "DocumentSnapshot": () => (/* binding */ Cu),
/* harmony export */   "FieldPath": () => (/* binding */ Jc),
/* harmony export */   "FieldValue": () => (/* binding */ Zc),
/* harmony export */   "Firestore": () => (/* binding */ kc),
/* harmony export */   "FirestoreError": () => (/* binding */ j),
/* harmony export */   "GeoPoint": () => (/* binding */ tu),
/* harmony export */   "LoadBundleTask": () => (/* binding */ Nc),
/* harmony export */   "Query": () => (/* binding */ Ac),
...
/* harmony export */   "_DatabaseId": () => (/* binding */ hc),
...
/* harmony export */   "collection": () => (/* binding */ bc),
...
/* harmony export */   "disableNetwork": () => (/* binding */ Qc),
/* harmony export */   "doc": () => (/* binding */ vc),
/* harmony export */   "documentId": () => (/* binding */ Yc),
/* harmony export */   "enableIndexedDbPersistence": () => (/* binding */ Lc),
/* harmony export */   "enableMultiTabIndexedDbPersistence": () => (/* binding */ Bc),
/* harmony export */   "enableNetwork": () => (/* binding */ jc),
/* harmony export */   "endAt": () => (/* binding */ Yu),
/* harmony export */   "endBefore": () => (/* binding */ Ju),
/* harmony export */   "ensureFirestoreConfigured": () => (/* binding */ Fc),
/* harmony export */   "executeWrite": () => (/* binding */ Th),
/* harmony export */   "getDoc": () => (/* binding */ ah),
...
/* harmony export */   "getFirestore": () => (/* binding */ Oc),
/* harmony export */   "increment": () => (/* binding */ Vh),
/* harmony export */   "initializeFirestore": () => (/* binding */ $c),
/* harmony export */   "limit": () => (/* binding */ ju),
/* harmony export */   "limitToLast": () => (/* binding */ Qu),
/* harmony export */   "loadBundle": () => (/* binding */ Gc),
/* harmony export */   "namedQuery": () => (/* binding */ zc),
...
/* harmony export */   "queryEqual": () => (/* binding */ Sc),
...
/* harmony export */   "terminate": () => (/* binding */ Wc),
/* harmony export */   "updateDoc": () => (/* binding */ _h),
/* harmony export */   "waitForPendingWrites": () => (/* binding */ Kc),
...
function bc(t, e, ...n) {
    if (t = (0,_firebase_util__WEBPACK_IMPORTED_MODULE_3__.getModularInstance)(t), fc("collection", "path", e), t instanceof Tc) {
 ...
 * Firestore database.
 */ function Vc(t, e) {
    return t = (0,_firebase_util__WEBPACK_IMPORTED_MODULE_3__.getModularInstance)(t), e = (0,_firebase_util__WEBPACK_IMPORTED_MODULE_3__.getModularInstance)(e), (t instanceof Ic || t instanceof Rc) && (e instanceof Ic || e instanceof Rc) && (t.firestore === e.firestore && t.path === e.path && t.converter === e.converter);
}
 ...
 * Firestore database.
 */ function Sc(t, e) {
    return t = (0,_firebase_util__WEBPACK_IMPORTED_MODULE_3__.getModularInstance)(t), e = (0,_firebase_util__WEBPACK_IMPORTED_MODULE_3__.getModularInstance)(e), t instanceof Ac && e instanceof Ac && (t.firestore === e.firestore && Ae(t._query, e._query) && t.converter === e.converter);
}
 ...
 */ function Oc(e = (0,_firebase_app__WEBPACK_IMPORTED_MODULE_0__.getApp)()) {
 ...
 */ function Iu(t, e, n) {
    ...
    // FieldPath.
    e = (0,_firebase_util__WEBPACK_IMPORTED_MODULE_3__.getModularInstance)(e)) instanceof Jc) return e._internalPath;
 ...
 */ class rh {
    ...
    update(t, e, n, ...s) {
        ...
        // performing validation.
                let r;
        return r = "string" == typeof (e = (0,_firebase_util__WEBPACK_IMPORTED_MODULE_3__.getModularInstance)(e)) || e instanceof Jc ? mu(this._dataReader, "WriteBatch.update", i._key, e, n, s) : _u(this._dataReader, "WriteBatch.update", i._key, e), 
...
function _h(t, e, n, ...s) {
    ...
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e = (0,_firebase_util__WEBPACK_IMPORTED_MODULE_3__.getModularInstance)(e)) || e instanceof Jc ? mu(r, "updateDoc", t._key, e, n, s) : _u(r, "updateDoc", t._key, e);
 ...
 */ class Ih extends class {
    ...
    update(t, e, n, ...s) {
        ...
        // performing validation.
                let r;
        return r = "string" == typeof (e = (0,_firebase_util__WEBPACK_IMPORTED_MODULE_3__.getModularInstance)(e)) || e instanceof Jc ? mu(this._dataReader, "Transaction.update", i._key, e, n, s) : _u(this._dataReader, "Transaction.update", i._key, e), 
...
}), "PUBLIC" /* PUBLIC */)), (0,_firebase_app__WEBPACK_IMPORTED_MODULE_0__.registerVersion)(S, "3.1.1", Dh), 
// BUILD_TARGET will be replaced by values like esm5, esm2017, cjs5, etc during the compilation
(0,_firebase_app__WEBPACK_IMPORTED_MODULE_0__.registerVersion)(S, "3.1.1", "esm2017");
...
/* harmony import */ var _leaderboard__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./leaderboard */ "./src/scripts/leaderboard.js");
...
var completeModal = document.querySelector('.complete-modal');
var submitBtn = document.querySelector('.modal__submit');
var cancelBtn = document.querySelector('.modal__cancel');
var homeBtn = document.querySelector('.header__home');
var leaderboardBtn = document.querySelector('.header__leaderboard');
var coordinates = {};
var runningTimer;
var timer = (0,_timer__WEBPACK_IMPORTED_MODULE_2__["default"])(); // Returns the coordinates of the cursor on click relative to the bounding element (warp core img in this case)
  ...
  if (e.target.classList.contains('popup__list-item')) {
    ...
    if (charClicked.length > 0) {
      ...
      if (e.target.dataset.name === charClicked[0]) {
        ...
        var _characters$filter = _model__WEBPACK_IMPORTED_MODULE_0__.characters.filter(function (char) {
          return char.name === charClicked[0];
        }),
            _characters$filter2 = _slicedToArray(_characters$filter, 1),
            charFound = _characters$filter2[0];

        charFound.toggleFound(); // Update UI to reflect char found

        (0,_view__WEBPACK_IMPORTED_MODULE_1__.toggleToast)('Found one!', 'success');
        (0,_view__WEBPACK_IMPORTED_MODULE_1__.updatePopupMenu)(e.target); // End game if all characters have been found

        if (!(0,_model__WEBPACK_IMPORTED_MODULE_0__.anyCharsRemaining)()) {
          timer.end(runningTimer);
          (0,_view__WEBPACK_IMPORTED_MODULE_1__.displayModal)(completeModal);
          document.querySelector('.modal__text-time').textContent = " ".concat(timer.getCurrentTime(), " ");
          document.querySelector('.modal__text-time').dataset.time = timer.getCurrentTime();
        }
      } else {
        (0,_view__WEBPACK_IMPORTED_MODULE_1__.toggleToast)('Hmm, not there...', 'error');
      }
    } else {
      (0,_view__WEBPACK_IMPORTED_MODULE_1__.toggleToast)('Hmm, not there...', 'error');
...
leaderboardBtn.addEventListener('click', function () {
  ...
  (0,_view__WEBPACK_IMPORTED_MODULE_1__.switchToLeaderboard)();
}); // Switching to home/image page should reset the timer and UI so the user can play again

homeBtn.addEventListener('click', function () {
  timer.end(runningTimer);
  timer.reset(); // Alter found status on all characters, then update header cards and popup menu
  ...
  (0,_view__WEBPACK_IMPORTED_MODULE_1__.updateHeaderCards)();
  (0,_view__WEBPACK_IMPORTED_MODULE_1__.removePopupStyling)();
  (0,_view__WEBPACK_IMPORTED_MODULE_1__.switchToImage)();
...
submitBtn.addEventListener('click', function () {
  ...
  var time = parseFloat(document.querySelector('.modal__text-time').dataset.time); // Reject empty name field as firebase will accept this on the backend otherwise

  if (name === "") {
    (0,_view__WEBPACK_IMPORTED_MODULE_1__.toggleToast)('Name cannot be left blank', 'error');
    throw new Error('Must enter name');
  } // Give the user visual indication that the request is in progress


  submitBtn.textContent = 'Submitting...'; // Call async function to add user to leaderboard, then close modal and switch page

  (0,_leaderboard__WEBPACK_IMPORTED_MODULE_3__.addUser)(name, time).then(function () {
    submitBtn.textContent = 'Submit';
    (0,_view__WEBPACK_IMPORTED_MODULE_1__.closeModal)(completeModal);
    (0,_view__WEBPACK_IMPORTED_MODULE_1__.switchToLeaderboard)();
  }); // .catch can be added here if necessary
}); // Avoid submitting high score, and instead return to the home/image page

cancelBtn.addEventListener('click', function () {
  (0,_view__WEBPACK_IMPORTED_MODULE_1__.closeModal)(completeModal); // Reset timer to zero but DO NOT start timer again here
...
var db = (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_1__.getFirestore)(app); // Query all documents in the users collection

var q = (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_1__.query)((0,firebase_firestore__WEBPACK_IMPORTED_MODULE_1__.collection)(db, 'users'), (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_1__.orderBy)('time')); // Get realtime updates of leaderboard. Note that snapshot.docs is an array of all the user documents from firestore

(0,firebase_firestore__WEBPACK_IMPORTED_MODULE_1__.onSnapshot)(q, function (snapshot) {
  (0,_view__WEBPACK_IMPORTED_MODULE_2__.renderLeaderboard)(snapshot.docs);
}, function (error) {
  console.log(error.message);
}); // Add new user document into the users collection

var addUser = function addUser(name, time) {
  var users = (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_1__.collection)(db, 'users');
  return (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_1__.addDoc)(users, {
    name: name,
    time: time
  });
};
...
/* harmony export */   "anyCharsRemaining": () => (/* binding */ anyCharsRemaining)
/* harmony export */ });
...
var characters = [waldo, yoda, walle, groot, robocop]; // Will return true if there are any characters that remain to be found. Use to control timer and other 'game-ending' features
...
function Timer() {
  var elapsed = '0.0';
  var running = false; // Run set interval function every 100 ms
  ...
  var begin = function begin() {
    ...
    var runningTimer = setInterval(function () {
      ...
      var time = new Date().getTime() - start; // Adjust elapsed time on each loop
...
/* harmony export */   "updatePopupMenu": () => (/* binding */ updatePopupMenu),
/* harmony export */   "removePopupStyling": () => (/* binding */ removePopupStyling),
/* harmony export */   "renderLeaderboard": () => (/* binding */ renderLeaderboard),
/* harmony export */   "toggleToast": () => (/* binding */ toggleToast),
/* harmony export */   "displayModal": () => (/* binding */ displayModal),
/* harmony export */   "closeModal": () => (/* binding */ closeModal),
/* harmony export */   "switchToImage": () => (/* binding */ switchToImage),
/* harmony export */   "switchToLeaderboard": () => (/* binding */ switchToLeaderboard)
/* harmony export */ });
/* harmony import */ var _model__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./model */ "./src/scripts/model.js");
...
var updateHeaderCards = function updateHeaderCards() {
  _model__WEBPACK_IMPORTED_MODULE_0__.characters.forEach(function (char) {
    if (char.isFound()) {
      document.querySelector("[data-name='".concat(char.name, "']")).style.opacity = '0.1';
    } else {
      document.querySelector("[data-name='".concat(char.name, "']")).style.opacity = '1';
    }
  });
}; // Cross off each name for characters found to aid user through the puzzle


var updatePopupMenu = function updatePopupMenu(element) {
  element.style.textDecoration = 'line-through';
  element.style.color = '#646464';
}; // Resets the popup menu styling to normal; used on puzzle restart


var removePopupStyling = function removePopupStyling() {
  document.querySelectorAll('.popup__list-item').forEach(function (item) {
...
var renderLeaderboard = function renderLeaderboard(users) {
  var leaderTable = document.querySelector('.leaderboard__table');
  var leaderboardSubtitle = document.querySelector('.leaderboard__subtitle'); // users.length will  be >0 when there is at least one recorded high score

  if (users.length !== 0) {
    // Render the users table
    leaderTable.innerHTML = '<tr><th class="header-rank">Rank</th><th class="header-name">Name</th><th class="header-time">Time (seconds)</th></tr>'; // Remove subtitle when scores exist

    leaderboardSubtitle.style.display = 'none'; // Render leaderboard

    users.forEach(function (user, index) {
      var data = user.data();
      var tr = document.createElement('tr'); // Create basic table row with the user data. Because the data is pre-sorted, the index can be used for the rank column
...
var toggleToast = function toggleToast(message, typeOfToast) {
  var toast = document.querySelector('.toast');
  toast.textContent = message;
  toast.className = 'toast toast--visible';
  toast.classList.add("toast--".concat(typeOfToast)); // Toast will fade out after 1 second
...
var displayModal = function displayModal(modal) {
  modal.style.display = 'flex'; // Reset any input field from a previous attempt
...
var switchToLeaderboard = function switchToLeaderboard() {
...
/* harmony import */ var _scripts_timer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./scripts/timer */ "./src/scripts/timer.js");
/* harmony import */ var _scripts_leaderboard__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./scripts/leaderboard */ "./src/scripts/leaderboard.js");
